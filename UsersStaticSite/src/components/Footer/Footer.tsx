...
function Footer(): React.ReactNode {
  ...
  return (
    <footer className="bg-black-200 text-white-100 w-full pb-10 before:bg-white-100 before:content-[''] before:w-full before:absolute before:h-[1px]" >
      <section className="flex flex-col gap-4 lg:gap-10 px-4 md:px-20 lg:px-40 2xl:px-64">
        <h3 className="text-2xl relative bottom-7 bg-black-200 w-fit p-3">
          Sobre
        </h3>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-between gap-10'>
          ...
          <img
            src="./src/assets/logos/ColetivoCafe.svg"
            alt="ColetivoCafe-logo"
            className='w-[100px] md:w-[90px] object-cover' />
          <img
            src="./src/assets/logos/GovernoFederal.svg"
